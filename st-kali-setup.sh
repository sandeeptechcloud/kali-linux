...
finalwork() {
	...
	wget -q "https://raw.githubusercontent.com/sandeeptechcloud/kali-linux/main/st-kali.sh" -O $HOME/st-kali.sh || \
		curl -sL "https://raw.githubusercontent.com/sandeeptechcloud/kali-linux/main/st-kali.sh" -o $HOME/st-kali.sh
