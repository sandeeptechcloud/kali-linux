...
# Update this URL to your GitHub repo after uploading
GITHUB_USER="YOUR_GITHUB_USERNAME"
GITHUB_REPO="YOUR_REPO_NAME"
FINALTOUCHUP_URL="https://raw.githubusercontent.com/${GITHUB_USER}/${GITHUB_REPO}/master/finaltouchup.sh"

finalwork() {
	[ -e $HOME/finaltouchup.sh ] && rm $HOME/finaltouchup.sh
	echo
	# Download finaltouchup.sh from your GitHub
	axel ${EXTRAARGS} -a "${FINALTOUCHUP_URL}" || \
		wget -q "${FINALTOUCHUP_URL}" -O $HOME/finaltouchup.sh
